...
`本文翻译自 [Hackoberfest官网](https://hacktoberfest.digitalocean.com/eventkit) ，英文原文已整理为Markdown [eventkit.md](eventkit.md)。Hacktoberfest 指__十月黑客节__，为方便交流一般不做翻译。`
...
## 参考步骤
1. 起草活动日程。
2. 确定日期：Confirm that your preferred venue and any co-organizers, speakers, and facilitators are available.
3. 推广活动：Invite your community to attend. And don't forget to add your event [here](http://do.co/hacktoberfest18event)!
...
* __Hack time__ Hacking together: facilitate the formation of groups by interest/[insert your community's preferred format].
